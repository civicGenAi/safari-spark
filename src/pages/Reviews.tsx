...
const reviews = [
  ...
  { stars: 4, text: "Arrived late at night, they were still there waiting. Felt safe the whole journey. True professionals.", name: "Lucas B.", flag: "🇩🇪", date: "Mar 2025" },
  ...
  { stars: 4, text: "We booked last-minute and they still delivered. Vehicle was waiting, driver was smiling. Couldn't ask for more.", name: "Marco S.", flag: "🇮🇹", date: "Jan 2025" },
  { stars: 5, text: "A truly premium experience. The Wi-Fi in the car was a lifesaver for our business trip. Highly recommended.", name: "David C.", flag: "🇨🇦", date: "Mar 2025" },
  { stars: 5, text: "Impeccable timing. We had a tight connection from JRO to Arusha Airport and the driver got us there safely and swiftly.", name: "Elena V.", flag: "🇪🇸", date: "Feb 2025" },
  { stars: 5, text: "The cars are new, clean, and air-conditioned. Makes a huge difference after a long flight.", name: "Michael W.", flag: "🇦🇺", date: "Jan 2025" },
  { stars: 4, text: "Good transfer from Moshi. Driver was polite. Overall a solid service.", name: "Kofi A.", flag: "🇬🇭", date: "Dec 2024" },
  { stars: 5, text: "WhatsApp booking is a game-changer. Sent a text, got a quote, and the car was there exactly as promised.", name: "Sophie M.", flag: "🇨🇭", date: "Mar 2025" },
  { stars: 5, text: "We used them for a multi-day private route. It was like having a local guide and driver in one. Fantastic!", name: "Oliver P.", flag: "🇳🇿", date: "Feb 2025" },
  { stars: 5, text: "Simply the best in Arusha. I use them every time I fly in for work.", name: "James K.", flag: "🇰🇪", date: "Jan 2025" },
];
